...
public class  User {
    ...
    @Id
    private String id;//主键 UUID 32位【工具类生成】
    private String loginAct;//登录账号
    private String name;//用户姓名
    private String loginPwd;//登录密码:不能明文登录  MD5加密方式
    private String email;//邮箱
    private String expireTime;//失效时间:注册的时候指定使用期限 yyyy-MM-dd hh:mm:ss 失效时间为空的时候表示永不失效 19位
